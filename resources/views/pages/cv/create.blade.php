            ...
            <div class="bg-white shadow-sm p-6 mt-10 border rounded-xl">
               <form action="/curriculum-vintae/create" method="POST">
                  ...
                  <div class="mt-6">
                     ...
                     <input id="publications" type="hidden" name="publications" value="{!! old('publications') !!}">
