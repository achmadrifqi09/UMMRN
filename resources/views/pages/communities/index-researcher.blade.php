         ...
         @foreach ($datas as $data)
            <div class="bg-white shadow-md rounded-xl">
               ...
               <div class="mt-20 p-4 pb-6 text-center">  
                     <a class="text-xl text-slate-900" href="/communities/detail/{{ $data->id }}">
                        {{ $data?->name }}
                     </a>
                  <p class="text-base mt-2 text-gray-500">
                     {!! $data?->description !!}
                  </p>
                     <a class="mt-4 left-4 px-3 rounded-full py-2 bg-lime-400 flex justify-center items-center" href="/communities/manage/{{ $data->id }}">
